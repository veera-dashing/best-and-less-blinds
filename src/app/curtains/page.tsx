      ...
      <section className="py-20 lg:py-28">
        <div className="mx-auto max-w-7xl px-6 sm:px-8">
          <div className="grid items-center gap-12 lg:grid-cols-2">
            <Reveal>
              <div className="relative aspect-[4/3] overflow-hidden rounded-[2rem] border border-oat/10 bg-cocoa-deep shadow-[0_30px_60px_-30px_rgba(0,0,0,0.4)]">
                <CategoryArt slug="curtains" />
              </div>
            </Reveal>
            <Reveal delay={120}>
              <p className="eyebrow text-tomato">Soften your space</p>
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {curtainTypes.map((c, i) => (
              <Reveal key={c.title} delay={(i % 4) * 110}>
                <div className="h-full rounded-3xl border border-oat/10 bg-cocoa-light p-7">
