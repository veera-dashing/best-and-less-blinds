...
export function PageHeader({
  ...
  return (
    <section className="relative overflow-hidden bg-espresso pt-32 pb-16 text-cream lg:pt-40 lg:pb-20">
      <div
        aria-hidden
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(217,182,118,0.5), transparent 65%)",
        }}
      />
      <div className="relative mx-auto max-w-7xl px-6 sm:px-8">
        ...
        <p className="eyebrow mt-6 text-brass-light">{eyebrow}</p>
